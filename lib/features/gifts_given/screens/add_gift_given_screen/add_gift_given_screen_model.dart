...
/// Model for
class AddGiftGivenScreenModel extends ElementaryModel {
  ...
  int get whoGaveId => _whoGaveId;
  set whoGaveId(int newWhoGaveId) {
    _whoGaveId = newWhoGaveId;
  }
  ...
  String get giftPrice => _giftPrice;

  set giftPrice(String newGiftPrice) {
    _giftPrice = newGiftPrice;
  }

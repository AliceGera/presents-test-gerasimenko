...
/// Model for [EditGiftGivenScreenModel]
class EditGiftGivenScreenModel extends ElementaryModel {
  ...
  set giftPrice(String newGiftPrice) {
    _gift = _gift.copyWith(giftPrice: newGiftPrice);
  }
